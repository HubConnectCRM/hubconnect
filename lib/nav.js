...
export const NAV_ITEMS = [
  ...
  { key: "mail", href: "/mail", icon: "mail", section: "more", roles: ["admin", "sales", "events"] },
  { key: "calls", href: "/calls", icon: "calls", section: "more", roles: ["admin", "sales", "events"] },
  { key: "calendar", href: "/calendar", icon: "calendar", section: "more" },
  { key: "chat", href: "/chat", icon: "chat", section: "more" },
  { key: "performance", href: "/performance", icon: "performance", section: "more", roles: ["admin", "sales", "events"] },
